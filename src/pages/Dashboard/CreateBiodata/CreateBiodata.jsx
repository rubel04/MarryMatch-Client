      ...
      <div>
        ...
        >
          ...
          <div>
            ...
            <select name="biodataType" required className="mt-1 w-full rounded">
          ...
          <div>
            ...
            <select required name="height" className="mt-1 w-full rounded">
          ...
          <div>
            ...
            <select required name="weight" className="mt-1 w-full rounded">
          ...
          <div>
            ...
            <select required name="race" className="mt-1 w-full rounded">
          ...
          <div>
            ...
            <select required name="occupation" className="mt-1 w-full rounded">
